...
<head>
    ...
    <title>TIP YOUR LOCAL - IMPRESSUM</title>
...
<div class="wrapper">
    ...
    <nav class="navbar navbar-light bg-light">
        ...
        <div class="navbar-nav col">
            <a class="navbar-brand" href="./index" style="text-align: center">TIP YOUR LOCAL</a>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <p>Fabio Sulser<br />
        Sch&ouml;nhauser Allee<br />
        175<br />
        10119 Berlin</p>

        <h2>Kontakt</h2>
        <p>E-Mail: <a href="mailto:help@tipyourlocal.com" target="_blank">help@tipyourlocal.com</a></p>
